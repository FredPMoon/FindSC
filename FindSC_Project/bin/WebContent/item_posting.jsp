				...
				<div id="itemPostingBox">
					<div id="inputFields">
						...
						<div class="inputField">
							...
							<div style="display: inline-block"><input type="text" value="Tony" name="name" placeholder="What did you lose?"></div>
						</div>
						<div class="inputField">
							<div class="icon" id="locationIcon" style="display: inline-block;margin-bottom: -8px;"></div>
							<div style="display: inline-block"><input type="text" value="Webb" name="location" placeholder="Where did you lose it?"></div>
						</div>
						<div class="inputField">
						...
						<div class = inputField>
							...
							<div style="display: inline-block"><input type="text" value="aaaa" name="description" placeholder="asddad"></div>
						</div>
						<div class="inputField">
							<div class="icon" id="rewardIcon" style="display: inline-block;margin-bottom: -8px;"></div>
