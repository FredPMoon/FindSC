...
<script>
	...
	function startSocket() {
		ws = new WebSocket("ws://localhost:8080/FindSC/ws");

		ws.onopen = function() {
			log("websocket has been opened");
			ws.send("itemid " + itemid);
		};
		...
		ws.onclose = function() {
			log("websocket has been closed");
		};
	}

	function refreshComments() {
		$('#commentField').load(
				'/FindSC/view_item?itemid=' + itemid + ' #commentField');
	}
...
<body class="homeBody" id="darkBackground">
	...
	<div class="bodyContent">
		<form name="aform" id="viewItemForm" method="POST" action="view_item">
